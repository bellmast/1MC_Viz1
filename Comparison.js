        ...
        for (x = 0; x < masterLength; x++) {
            if (avgxCoord == masterxArray[x] && avgyCoord == masteryArray[x]) {
                ...
                if (layer%2 == 1) {
                    ...
                    avgxCoord += ((ourRadius*layer*1.5)*Math.sin((Math.PI/180)*(60*(masterCirclePackingArray[x]%6))))
                    avgyCoord += ((ourRadius*layer*1.5)*Math.cos((Math.PI/180)*(60*(masterCirclePackingArray[x]%6))))
                }
